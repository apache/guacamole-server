...
guac_drv_list* guac_drv_list_alloc() {
    ...
    guac_drv_list* list = malloc(sizeof(guac_drv_list));
...
guac_drv_list_element* guac_drv_list_add(guac_drv_list* list, void* data) {
    ...
    guac_drv_list_element* element = malloc(sizeof(guac_drv_list_element));
    element->data = data;
...
void guac_drv_list_remove(guac_drv_list* list,
        guac_drv_list_element* element) {
