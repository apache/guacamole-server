...
#ifndef GUAC_IPMI_INPUT_H
#define GUAC_IPMI_INPUT_H
 ...
 * events are received.
 */
guac_user_mouse_handler guac_ipmi_user_mouse_handler;

/**
 * Handler for size events. Required by libguac and called whenever the remote
 * display (window) is resized.
 */
guac_user_size_handler guac_ipmi_user_size_handler;
