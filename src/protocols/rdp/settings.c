...
guac_rdp_settings* guac_rdp_parse_args(guac_user* user,
    ...
    settings->port = (unsigned short)
        guac_user_parse_args_int_bound(user, GUAC_RDP_CLIENT_ARGS, argv, IDX_PORT,
    ...
    settings->gateway_port = (unsigned short)
        guac_user_parse_args_int_bound(user, GUAC_RDP_CLIENT_ARGS, argv,
                IDX_GATEWAY_PORT, 443, -1, USHRT_MAX);
