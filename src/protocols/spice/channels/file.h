...
/**
 * Error code returned when too many files are open.
 */
...
/**
 * Error code returned when a directory operation is attempted on a
 * non-directory.
 */
#define GUAC_SPICE_FOLDER_ENOTDIR -3

/**
 * Error code returned when insufficient space exists to complete the operation.
 */
#define GUAC_SPICE_FOLDER_ENOSPC -4

/**
 * Error code returned when a non-directory operation is attempted on a
 * directory.
 */
#define GUAC_SPICE_FOLDER_EISDIR -5

/**
 * Error code returned when the user lacks sufficient privileges.
 */
#define GUAC_SPICE_FOLDER_EACCES -6

/**
 * Error code returned when the file already exists.
 */
#define GUAC_SPICE_FOLDER_EEXIST -7

/**
 * Error code returned when the operation is invalid.
 */
...
/**
 * The maximum number of files that may be open within the shared folder at any
 * given time.
 */
#define GUAC_SPICE_FOLDER_MAX_FILES 128

/**
 * The maximum number of path components (directories) in any normalized path.
 */
