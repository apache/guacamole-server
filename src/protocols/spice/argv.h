...
/**
 * The name of the parameter Guacamole will use to specify/update the SPICE
 * password (ticket).
 */
...
/**
 * Handler which is invoked when the value of a connection parameter is being
 * updated at runtime via an inbound "argv" stream.
 */
