...
/**
 * Returns the memory address of given rectangle within the image buffer of the
 * given guac_display_layer_raw_context, where the upper-left corner of the
 ...
 *     within which the address of given rectangle should be determined.
 *
 * @param rect
